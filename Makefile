#############################################################################
# Makefile for building: PioneerCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Jun 12 00:40:37 2014
# Project:  PioneerCoin-qt.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile PioneerCoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/src/leveldb/libleveldb.a /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
$(TARGET): /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/src/leveldb/libleveldb.a /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: PioneerCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile PioneerCoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/PioneerCoin-qt0.9.0.0 || $(MKDIR) build/PioneerCoin-qt0.9.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/PioneerCoin-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/PioneerCoin-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/hashblock.h src/sph_blake.h src/sph_skein.h src/sph_keccak.h src/sph_jh.h src/sph_groestl.h src/sph_bmw.h src/sph_types.h src/sph_luffa.h src/sph_cubehash.h src/sph_echo.h src/sph_shavite.h src/sph_fugue.h src/sph_hamsi.h src/sph_simd.h build/PioneerCoin-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/PioneerCoin-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcdarksend.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/blake.c src/bmw.c src/groestl.c src/jh.c src/keccak.c src/skein.c src/luffa.c src/cubehash.c src/shavite.c src/echo.c src/fugue.c src/hamsi.c src/simd.c build/PioneerCoin-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/PioneerCoin-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/PioneerCoin-qt0.9.0.0/ && (cd `dirname build/PioneerCoin-qt0.9.0.0` && $(TAR) PioneerCoin-qt0.9.0.0.tar PioneerCoin-qt0.9.0.0 && $(COMPRESS) PioneerCoin-qt0.9.0.0.tar) && $(MOVE) `dirname build/PioneerCoin-qt0.9.0.0`/PioneerCoin-qt0.9.0.0.tar.gz . && $(DEL_FILE) -r build/PioneerCoin-qt0.9.0.0


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/src/leveldb/libleveldb.a; cd /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/src/leveldb/libleveldb.a: FORCE
	cd /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/build/build.h: FORCE
	cd /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin; /bin/sh share/genbuild.sh /home/zhuxiao/altcoins/dev/dark2x13/PioneerCoin/build/build.h
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp
...
build/moc_coincontroldialog.cpp: src/qt/coincontroldialog.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/coincontroldialog.h -o build/moc_coincontroldialog.cpp

build/moc_coincontroltreewidget.cpp: src/qt/coincontroltreewidget.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/coincontroltreewidget.h -o build/moc_coincontroltreewidget.cpp
...
build/moc_signverifymessagedialog.cpp: src/qt/signverifymessagedialog.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/signverifymessagedialog.h -o build/moc_signverifymessagedialog.cpp
...
build/moc_bitcoinaddressvalidator.cpp: src/qt/bitcoinaddressvalidator.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/bitcoinaddressvalidator.h -o build/moc_bitcoinaddressvalidator.cpp
...
build/moc_guiutil.cpp: src/qt/guiutil.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/guiutil.h -o build/moc_guiutil.cpp
...
build/moc_bitcoinamountfield.cpp: src/qt/bitcoinamountfield.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/bitcoinamountfield.h -o build/moc_bitcoinamountfield.cpp
...
build/moc_walletview.cpp: src/qt/walletview.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/walletview.h -o build/moc_walletview.cpp

build/moc_walletstack.cpp: src/qt/walletstack.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/walletstack.h -o build/moc_walletstack.cpp

build/moc_walletframe.cpp: src/qt/walletframe.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/walletframe.h -o build/moc_walletframe.cpp
...
build/moc_bitcoinunits.cpp: src/qt/bitcoinunits.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/bitcoinunits.h -o build/moc_bitcoinunits.cpp
...
build/moc_paymentserver.cpp: src/qt/paymentserver.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/paymentserver.h -o build/moc_paymentserver.cpp

build/moc_rpcconsole.cpp: src/qt/rpcconsole.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/rpcconsole.h -o build/moc_rpcconsole.cpp

build/moc_macnotificationhandler.cpp: src/qt/macnotificationhandler.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/macnotificationhandler.h -o build/moc_macnotificationhandler.cpp

build/moc_splashscreen.cpp: src/qt/splashscreen.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/splashscreen.h -o build/moc_splashscreen.cpp
...
build/rpcconsole.moc: src/qt/rpcconsole.h \
		...
		src/qt/guiutil.h \
		src/qt/rpcconsole.cpp
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/rpcconsole.cpp -o build/rpcconsole.moc
