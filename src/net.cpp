...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PioneerCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node1", "node1.pioneercoin.org"},
    {"node2", "node2.pioneercoin.org"},
    {"node3", "node3.pioneercoin.org"},
    {"node4", "node4.pioneercoin.org"},
    {"node5", "node5.pioneercoin.org"},
    {"node6", "node6.pioneercoin.org"},
    {NULL, NULL},
};

static const char *strTestNetDNSSeed[][2] = {
    {"", "node1.pioneercoin.org"},
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PioneerCoin is probably already running."), addrBind.ToString().c_str());
        else
